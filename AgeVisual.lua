-- Pet Level Up UI (Wood Style) with Flexible Pet Name Check and Mini Loading
-- Ages up pet one by one: shows loading, adds +1 Age, notification pops up, repeats until Age 50.
...
local validPets = {
    ...
    "Disco Bee","Mimic Octopus","Spinosaurus","Queen Bee", "Praying Mantis", "Blood Owl"
}
